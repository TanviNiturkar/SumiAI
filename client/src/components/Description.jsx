      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>
                ...
                your text into eye-catiching images with just a few clicks. Imagine it, 
                describe it, and watch it come to life instantly.
            </p>
            <p className='text-gray-600'>
                Simply type in a text prompt, and or cutting-edge product visuals to character
                designs and portraits, even concepts that don't yet exits can ve visualized 
                effortlessly. Powered by advanced AI technology, the creative possiblities are limitless!
            </p>
        </div>
      </div>
